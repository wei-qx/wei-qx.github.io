export const site = {
  hero: {
    ...
    author: { zh: 'Wind', en: 'Wind' },
    date: '2026-08-05',
  },
  about: {
    body: {
      zh: [
        '我是 Wind，一名工程师。这里是我随手记下的工程笔记、阅读摘抄与偶尔的想法。没有排期，也不追热点——想到什么写什么，权当给自己的备忘。',
        '如果某篇对你有用，那就算我没白写。',
      ],
      en: [
        "I'm Wind, an engineer. This is where I keep engineering notes, reading highlights, and the occasional thought. No schedule, no hot takes — just things I didn't want to forget.",
  ...
  footer: {
    ...
    copy: { zh: '© 2026 Wind。随手写于某处。', en: '© 2026 Your Name. Scribbled somewhere.' },
